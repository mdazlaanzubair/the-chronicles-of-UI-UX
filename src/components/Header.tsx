...
const Header = ({
  ...
  return (
    <>
      ...
      {/* floating bar */}
      <div
        className={`flex flex-col w-full lg:w-[500px] fixed top-0 bg-base-200/70 backdrop-blur mx-auto ${
          showFloatBar ? "opacity-100 z-50" : " opacity-0 -z-10"
        } transition-all ease-in-out duration-300`}
      >
        <div className="navbar w-full h-auto bg-transparent">
          <div className="navbar-start pl-3">
            <DarkModeToggler />
          </div>
          <div className="navbar-center">
        ...
        {/* scroll progress */}
        <div className="block w-full h-[2px] bg-base-300">
          <div
            className="h-full bg-neutral transition-all ease-linear duration-150"
