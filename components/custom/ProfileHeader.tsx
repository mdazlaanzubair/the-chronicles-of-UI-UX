  ...
  return (
    <header className="flex w-full flex-col bg-card text-foreground">
      ...
      <div className="relative h-36 w-full overflow-hidden border-b border-accent">
        <img
          src="/orange-cover.jpg"
          alt="Cover photo"
          className="h-full w-full object-cover object-center"
        />
        <h2 className="absolute top-[50%] left-[50%] translate-[-50%] translate-y-[-50%] text-4xl font-bold text-primary-foreground">
          Hello World
        </h2>
      </div>

      {/* Profile Info Container */}
      <div className="border-b border-accent px-4 pb-4">
